...
const renderCategories = () => {
    ...
    categories.forEach((category) => {
        // GETTING ALL THE TASKS OF CURRENT CATEGOERY
        const categoryTask = tasks.filter(
            (task) => task.category.toLowerCase() === category.title.toLowerCase()
        );

        //CREATING A DIV TO RENDER CATEGORIES
        const div = document.createElement("div");
            ...
            div.addEventListener("click", () => {
                ...
                calculateTotal();
                //RENDER TASK WHEN CATEGORIES CHANGE
                renderTasks();
            });
            div.innerHTML = `
            <div class="left">
...
const renderTasks = () => {
  ...
  //IF THERES NO TASK FOR A SELECTED CATEGORY
  if (categoryTasks.length === 0) {
    tasksContainer.innerHTML = `
    <p class="no-task">No tasks for this category</p>
    `;
  } else{
    //IF THERES ARE TASKS FOR A SELECTED CATEGORY RENDER THEM
...
//ADDING FUNCTIONALITY TO NEW TASKS
